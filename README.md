...
O CarnaCode é um evento online e gratuito que acontece nos dias 10, 11, 12 e 13 de Fevereiro, quando tive a oportunidade de codificar uma aplicação Web (Blazor + PWA) completa, do começo ao fim.
